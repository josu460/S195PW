    ...
    <div class="card text-center">
        ...
        <img src="{{ asset('img/han.webp') }}" class="img-han" alt="Noticia Literaria">
            <p class="card-text">Han, de 53 años, comenzó su carrera con un grupo de poemas en una revista surcoreana, antes de debutar en prosa en 1995 con una colección de relatos cortos. Más tarde empezó a escribir obras en prosa más largas, entre las que destaca “La vegetariana” (“The vegetarian”), uno de sus primeros libros traducidos al inglés. La novela, que ganó el premio Man Booker International en 2016, narra el intento de una joven para vivir una existencia más “vegetal” tras sufrir macabras pesadillas sobre la crueldad humana.
                ...
                Pero la escritura “intensa y lírica” de Han casi actúa como consuelo frente a esta violencia histórica, añadió Palm. “Su prosa, muy tierna y precisa, se convierte casi en un contrapunto al brutal ruido del poder”, afirmó.

                Antes del anuncio, Ellen Mattson, otra integrante del comité, detalló cómo el jurado selecciona cada año al galardonado.

                “Empezamos con una lista muy larga de unos 220 nombres”, explicó Mattson. “Luego tenemos que navegar a través de esa enorme masa de nombres - y ahí necesitamos la ayuda de expertos de diferentes partes del mundo”.

                Al final, el comité llega a una colección de “unos 20 nombres”, que luego se reduce a una preselección de cinco autores. “Ahí es donde empieza el verdadero trabajo”, explica Mattson.

                A continuación, cada miembro del comité tiene que “leer todo lo que escriban esos cinco autores” para empezar a perfilar un único ganador.</p>
        </div>
