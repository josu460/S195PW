    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content fw-bold">
            ...
            <div class="modal-body text-primary">
                ...
                <form method="POST" action="{{ route('cliente.update', $item->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="telefono" value="{{$item->telefono}}">
                    </div>
                    @session ('actualizado')
                    <script>
                        Swal.fire({
                            title: "Respuesta del servidor",
                            text: "Se actualizo el cliente: {{$value}}",
                            icon: "success"
                        });
                    </script>
                    @endsession
