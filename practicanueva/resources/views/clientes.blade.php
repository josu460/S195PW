...
<div class="container mt-5 col-md-8">
    ...
    <div class="card text-justify font-monospace">
        ...
        <div class="card-footer text-muted">
            ...
            <button type="button" class="btn btn-warning btn-sm " data-bs-toggle="modal" data-bs-target="#modalUpdate">
                Actualizar
            </button>


            <div class="modal fade" id="modalUpdate" tabindex="-1" aria-labelledby="actualizarClienteLabel" aria-hidden="true">
            ...
            <div class="modal fade" id="modalEliminar" tabindex="-1" aria-labelledby="eliminarCliente" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalEliminar">Confirmación</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
